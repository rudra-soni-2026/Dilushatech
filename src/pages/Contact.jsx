...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // IMPORTANT: Get your Access Key from https://web3forms.com/ and replace 'YOUR_ACCESS_KEY_HERE'
    const payload = {
      ...formData,
      access_key: 'dc4bde2d-b821-4e02-97e8-aa86bdaec07e', // User needs to replace this
    ...
    try {
      ...
      if (result.success) {
        ...
        setStatus('success'); // Fallback for UI testing
      }
    } catch (err) {
    ...
    <div className="contact-page">
      ...
      <section className="u-section" style={{ paddingTop: '120px', paddingBottom: '4rem' }}>
        <div className="u-container" style={{ maxWidth: '1100px' }}>
          <div className="contact-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div className="contact-form-container" style={{ background: '#ffffff', padding: '2.5rem', borderRadius: '24px', border: '1px solid rgba(0,0,0,0.08)', boxShadow: '0 20px 40px rgba(0,0,0,0.02)' }}>
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.4rem' }}>
                ...
                {status === 'error' && <p style={{ color: '#ef4444', fontSize: '0.85rem', textAlign: 'center', marginTop: '10px', fontWeight: '600' }}>Something went wrong. Please try again later.</p>}
              </form>
            </div>
