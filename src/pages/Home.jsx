...
const Home = () => {
  return (
    <div className="home-page">
      ...
      <Navbar />
      <a 
        href={`https://wa.me/917470818764?text=${encodeURIComponent("Hello DilushaTech! 🚀 I'm looking for professional digital solutions (Website / Digital Marketing / Software) for my brand. I'd love to discuss a project with you!")}`}
